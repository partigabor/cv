...
\begin{cventries}
  ...
  \cventry
    ...
    \cventry
    {Indonesian Language Course -- Darmasiswa Scholarship Program from the Republic of Indonesia} % Degree
  ...
  \cventry
    {Arabic Language Course -- scholarship from the Republic of Tunisia} % Degree
